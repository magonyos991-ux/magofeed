# Magofeed — Textes de la fiche store (FR)

Prêt à copier-coller. Compteurs de caractères respectant les limites Apple/Google.
Vérifie les chiffres (nombre de magasins, pays) avant publication.
...
**Ta boisson préférée est en rupture partout ? Magofeed te dit où la trouver.**
...
• Des informations fraîches, vérifiées par de vraies personnes
• Une carte qui grandit à chaque contribution
• Gratuit, sans pub intrusive, sans traceur publicitaire
...
## Mots-clés App Store (max 100, séparés par des virgules, sans espaces superflus)
`boisson,soda,ice tea,energy drink,magasin,stock,carte,scan,communauté,jus,où acheter,proximité` *(94)*

## Catégorie
- **Principale** : Shopping *(ou Style de vie)*
- **Secondaire** (Play) : Style de vie
- **Classification d'âge** : Tout public / 3+

## Nouveautés (What's New — pour cette version)
`• Suppression de compte directement dans l'app (Réglages)
• Sécurité et accessibilité renforcées
• Correctifs d'affichage plein écran sur iPhone`
