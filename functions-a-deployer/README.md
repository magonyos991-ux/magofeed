...
| `don-notification.js` | **Notification push à chaque don** : Ko-fi prévient, l'app te le dit sur ton téléphone — montant, nom, message | Faible (ne touche à aucun paiement) | Quand tu veux. Ko-fi n'a pas d'app iPhone : sans ça, il reste l'e-mail (complet mais noyé) ou l'app PayPal (le montant seul) |
